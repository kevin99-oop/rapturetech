    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dpu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='drecs', to='common.dpu')),
                ('user', models.ForeignKey(limit_choices_to={'dpu__status': 'active'}, on_delete=django.db.models.deletion.CASCADE, related_name='drecs', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
