...
from apps.common.views import (
    ...
    get_cid_range,get_cust_info,customer_list,config_api,DownloadConfigByStIdView
)
...
urlpatterns = [
    ...
    path('admin/common/config/download/<str:st_id>/', DownloadConfigByStIdView.as_view(), name='download_config_by_st_id'),
