...
from apps.common.views import (
    ...
    DRECViewSet, NtpDatetimeView, dpudetails, edit_dpu,upload_customer_csv,download_latest_csv,CIDRangeAPIView
)
...
urlpatterns = [
    ...
    path('api/cidrange/', CIDRangeAPIView.as_view(), name='cid_range_api'),
