...
from apps.common.views import HomeView, SignUpView, DashboardView, ProfileUpdateView, ProfileView, ShiftreportView, UserRegistrationView, UserLoginView, add_dpu, active_dpu,DRECViewSet,NtpDatetimeView,CustomerUploadView,get_cid_range,show_file_data
...
urlpatterns = [
    ...
    path('api/cidrange/', get_cid_range, name='api_custupload'),
